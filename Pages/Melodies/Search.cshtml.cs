...
namespace Melodies25.Pages.Melodies
{
    public class SearchModel : PageModel
    {
        ...
        // ���� position = -1, ��� �� � �������� (��� ��������� �������������)
        // ���� position >= 0, ��� � �������� (��� ��������� �������)
        // �������� �� ������ ��� ������� (melodyIndex, patternIndex) ��� ����������� ������� � ����� Subsequence
        // ���������� �� commonLength � �������� �������
        // ��������������� � OnPostNotesearch
                    ...
                    case "subsequence":
                        {
                            ...
                            // TEMPORARY: restrict subsequence search to songs whose Title starts with Cyrillic '�'
                            /*
                            if (string.IsNullOrEmpty(melody.Title) || !melody.Title.StartsWith("�", StringComparison.CurrentCultureIgnoreCase))
                            {
        ...
        {
            MessageL(COLORS.gray, $"Skipping subsequence for '{title}' � title does not start with '�'");
